package com.sagmcu.KirosUtilities.mechanisms;
...
public class PistonBlocker implements Listener {
    ...
    private void loadBlockedMaterials() {
        ...
        List<String> materialNames = config.getStringList("blocked_blocks");
